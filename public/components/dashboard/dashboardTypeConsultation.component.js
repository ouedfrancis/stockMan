...
ChartJS.register(ArcElement, Tooltip, Legend);
 ...
 /* eslint-disable */
const TypeConsultationDatas = (props) => {
...
const handleQueryChange = event => {
 ...
 setQuery({ ...query, [name]: value });
    retrieveTypeConsultationDatas(value);
};


async function retrieveTypeConsultationDatas (value){
    ...
    resp= await DashboardsDataService.groupAndCountConsultationByTypeConsultationAsync(q); 
    if(resp!=null && resp.status=="200" )          
        {              
             let obj={... InitialData}
               ...
               setData(obj)
               console.log("groupAndCountConsultationByTypeConsultationAsync",resp.data)
...
export default TypeConsultationDatas;