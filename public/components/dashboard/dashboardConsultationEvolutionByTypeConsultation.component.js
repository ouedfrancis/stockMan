...
ChartJS.register(
 ...
 /* eslint-disable */
const DashboardConsultationEvolutionByTypeConsultation = (props) => {
...
useEffect(() => {
    retrieveConsultationEvolutionByTypeConsultation();
...
const handleQueryChange = event => {
 ...
 //   console.log("query==>",query)
    retrieveConsultationEvolutionByTypeConsultation(value);
};


async function retrieveConsultationEvolutionByTypeConsultation (value){
   ...
   {   if(value=="3A")
    ...
    resp= await DashboardsDataService.countConsultationEvolutionByTypeConsultationAsync(q); 
    if(resp!=null && resp.status=="200" )          
        {              
          ...
          console.log("countConsultationEvolutionByTypeConsultationAsync",resp.data)
        setData(obj)
...
return (
   <section className="accordion">
              <input type="checkbox" name="collapse" id={`evolTypeSoinByPeriode-${props.typeSoins}`} defaultChecked />
              <h2 className="handle">
                <label htmlFor={`evolTypeSoinByPeriode-${props.typeSoins}`}>{props.title}</label>
              </h2>
...
export default DashboardConsultationEvolutionByTypeConsultation;