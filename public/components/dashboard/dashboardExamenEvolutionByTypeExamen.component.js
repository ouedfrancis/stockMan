...
ChartJS.register(
 ...
 /* eslint-disable */
const DashboardExamenEvolutionByTypeExamen = (props) => {
...
useEffect(() => {
    retrieveExamenEvolutionByTypeExamen();
...
const handleQueryChange = event => {
 ...
 //   console.log("query==>",query)
    retrieveExamenEvolutionByTypeExamen(value);
};


async function retrieveExamenEvolutionByTypeExamen (value){
   ...
   {   if(value=="3A")
    ...
    resp= await DashboardsDataService.countExamenEvolutionByTypeExamenAsync(q); 
    if(resp!=null && resp.status=="200" )          
        {              
          ...
          console.log("countExamenEvolutionByTypeExamenAsync",resp.data)
        setData(obj)
...
export default DashboardExamenEvolutionByTypeExamen;