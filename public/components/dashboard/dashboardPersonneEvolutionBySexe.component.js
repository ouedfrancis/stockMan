...
ChartJS.register(
 ...
 /* eslint-disable */
const DashboardPersonneEvolutionBySexe = (props) => {
...
useEffect(() => {
    retrievePersonneEvolutionBySexe();
...
const handleQueryChange = event => {
 ...
 //   console.log("query==>",query)
    retrievePersonneEvolutionBySexe(value);
};


async function retrievePersonneEvolutionBySexe (value){
   ...
   /* if(props.typeSoins!=null)
    ...
    resp= await DashboardsDataService.countPersonneEvolutionBySexeAsync(q); 
    if(resp!=null && resp.status=="200" )          
        {              
          ...
          console.log("countPersonneEvolutionBySexeAsync",resp.data)
        setData(obj)
...
export default DashboardPersonneEvolutionBySexe;